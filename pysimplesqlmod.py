...
'''
MODIFICATIONS INDICATED WITH '# mod'
'''
...
class Table:
    ...
    def prompt_save(self):
        pass # mod, disable prompt save method because of faulty behavor. Comfirming with OK causes data not saved.
        """
    ...
    def delete_record(self, cascade=True, ask=True): # mod insertet ask
        """
        ...
        # callback
        if ask == True: # mod if statement to check ask
